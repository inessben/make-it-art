...
const seoByRoute = {
  ...
  "/wishlist": [
    "Wishlist",
    "Review the digital artworks saved to your wishlist.",
  ],
  "/collections": [
  ...
  "/orders": [
    "Order History",
    "Review your purchases and download acquired artworks.",
  ],
  "/payment-methods": [
    "Payment Methods",
    "Manage the payment methods linked to your account.",
  ],
  "/settings": ["Settings", "Manage your ACCOUNT preferences."],
  "/wallet": ["Wallet", "Review your balance and recent wallet activity."],
  "/shopping-basket": [
    "Shopping Basket",
    "Review the artworks in your shopping basket.",
  ],
  "/become-artist": [
    "Become an Artist",
  ...
  "/admin": [
    "Admin Dashboard",
    "Monitor users, artists, artworks, orders and payments.",
  ],
};
...
const currentSeo = computed(() => {
  ...
  if (route.path.startsWith("/artworks/")) {
    return [
      "Artwork Details",
      "View artwork details, artist information and purchase options.",
    ];
  }
  if (route.path.startsWith("/artists/")) {
    return [
      "Artist Profile",
      "Discover an artist, their artworks and public collections.",
    ];
  }
  if (route.path.startsWith("/orders/")) {
    return [
      "Order Details",
      "Review an order and download your purchased artworks.",
    ];
  }
