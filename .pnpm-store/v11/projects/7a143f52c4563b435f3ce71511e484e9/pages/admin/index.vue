<template>
  <main class="min-h-screen bg-black px-4 py-6 text-slate-100 sm:px-5 sm:py-8">
    ...
    >
      ...
      >
        <div
          class="flex min-h-[116px] items-center gap-4 border-b border-slate-800 px-8"
        >
          <div
        ...
        <nav class="px-4 py-8" aria-label="Admin navigation">
          ...
          <div class="mt-5 grid">
            <NuxtLink
              ...
              "
            >
              <span class="w-7 text-center text-subtitle-2">{{
                item.icon
              }}</span
              >{{ item.label }}
            </NuxtLink>
          ...
          <p
            class="mt-10 px-4 text-subtitle-3 uppercase tracking-[0.25em] text-slate-500"
          >
            System
          </p>
          <div class="mt-5 grid">
        ...
        <div
          class="mt-auto flex items-center justify-between border-t border-slate-800 px-8 py-7"
        >
          <div>
            <p class="text-subtitle-3 uppercase text-slate-500">
              Admin session
            </p>
      ...
      <section class="min-w-0 bg-black">
        ...
        <div class="p-5 lg:p-8">
          ...
          <section class="mt-8 grid gap-8 xl:grid-cols-[minmax(0,1fr)_278px]">
            <article
              class="border border-slate-800 bg-gradient-to-br from-slate-950 to-black"
            >
              <div
                class="flex items-center justify-between border-b border-slate-800 px-6 py-5"
              >
                <h2 class="text-body-1 uppercase tracking-[0.08em]">
                  Platform overview
                </h2>
                <button
                  type="button"
              ...
              <div class="flex min-h-[340px] items-end gap-7 px-8 pb-10 pt-14">
                ...
                >
                  <span class="text-subtitle-2 text-slate-400">{{
                    bar.value
                  }}</span>
                  <div
                  ...
                  />
                  <span class="text-subtitle-3 uppercase text-slate-500">{{
                    bar.label
                  }}</span>
                </div>
              </div>
            ...
            >
              ...
              <div
                ...
                class="p-6 text-footer text-slate-500"
              >
          ...
          <section
            class="mt-8 border border-slate-800 bg-gradient-to-br from-slate-950 to-black"
          >
            <div
              class="flex items-center justify-between border-b border-slate-800 px-6 py-5"
            >
            ...
            <p
              class="border-b border-slate-800 px-5 py-3 text-subtitle-3 text-slate-500 sm:hidden"
            >
...
const adminInitials = computed(() =>
  getArtistInitials(auth.user?.username || "Admin"),
);
