<template>
  <footer id="about-us" class="bg-black text-slate-100 md:min-h-[685px]">
    <div
      class="mx-auto flex w-full max-w-[1176px] flex-col px-6 py-16 md:min-h-[685px] md:pb-[126px] md:pt-[140px]"
    >
