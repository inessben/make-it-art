    ...
    >
      <div class="grid gap-8 px-6 py-7 sm:px-8 sm:py-8 xl:grid-cols-[minmax(0,1.2fr)_340px]">
        <div>
          ...
          <h1
            class="mt-4 text-[clamp(2.1rem,4vw,3.5rem)] font-semibold leading-[0.96] tracking-[-0.04em] text-white"
          >
            Your artist access is waiting for approval
          </h1>
          <p class="mt-4 max-w-3xl text-sm leading-7 text-[#96A4B8]">
            Your agreement has been signed and submitted successfully. The admin team is now
            reviewing your application before activating your public artist profile and workspace
            permissions.
          </p>
          ...
          <div class="mt-6 grid gap-3 sm:grid-cols-3">
            ...
            >
              ...
              <p class="mt-3 text-sm font-semibold text-white">Signed and stored</p>
              <p class="mt-2 text-xs leading-6 text-[#96A4B8]">
                Your PDF agreement and signature are already on file.
              </p>
            </article>
            <article class="rounded-[22px] border border-white/8 bg-white/[0.03] px-4 py-4">
              ...
              <p class="mt-3 text-sm font-semibold text-white">Admin verification</p>
              <p class="mt-2 text-xs leading-6 text-[#96A4B8]">
                The team is checking your submitted identity and profile details.
              </p>
            </article>
            <article class="rounded-[22px] border border-white/8 bg-white/[0.03] px-4 py-4">
              <p class="text-[0.68rem] font-semibold uppercase tracking-[0.18em] text-[#8AA2FF]">
              ...
              <p class="mt-3 text-sm font-semibold text-white">Artist tools unlocked</p>
              <p class="mt-2 text-xs leading-6 text-[#96A4B8]">
                After approval, publishing and dashboard access become available.
              </p>
            </article>
          </div>
        </div>
        ...
        <div class="grid gap-4 self-start">
          ...
          >
            ...
            <dl class="mt-5 grid gap-3 text-sm">
              ...
              <div class="rounded-[18px] border border-white/6 bg-black/20 px-4 py-3">
                <dt class="text-xs uppercase tracking-[0.14em] text-[#7E8AA3]">Profile access</dt>
                <dd class="mt-2 font-semibold text-white">Waiting for activation</dd>
              </div>
            </dl>
          </article>
        </div>
      ...
      >
        <div>
          ...
          <p class="mt-3 max-w-3xl text-sm leading-7 text-[#96A4B8]">
            You can keep a copy of your signed agreement and return later to follow the validation
            status. Your artist features will unlock automatically once the application is approved.
          </p>
        </div>
