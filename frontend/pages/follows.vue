    ...
    >
      <header class="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p class="mt-4 max-w-3xl text-sm leading-6 text-[#A0ADB4]">
            Consultez les artistes que vous suivez et, si vous avez un profil artiste, les membres qui vous suivent.
          </p>
        </div>
      ...
      <section class="flex flex-wrap gap-2 rounded-[24px] border border-[#1A1F2A] bg-[#090017] p-2">
        <button
          ...
          :class="activeTab === 'following' ? 'bg-[#4A6CF7] text-black' : 'text-[#C9D6FF] hover:bg-[#101827]'"
        ...
        <button
          type="button"
          class="rounded-[16px] px-5 py-2.5 text-sm font-semibold transition"
          :class="activeTab === 'followers' ? 'bg-[#4A6CF7] text-black' : 'text-[#C9D6FF] hover:bg-[#101827]'"
