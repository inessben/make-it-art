...
const CONTRACT_VERSION = "make-it-art-artist-contract-v3";
...
5.3 Jusqu'a l'activation de Stripe Connect et a une nouvelle validation contractuelle, Make It Art est le marchand officiel : la Plateforme porte la relation client, encaisse les ventes, emet la facture de vente, traite les remboursements et les litiges et assume les frais du prestataire de paiement.

ARTICLE 6 - REMUNERATION ET CONDITIONS DE PAIEMENT
6.1 La Plateforme preleve une commission fixe de 7 % sur le montant hors taxes de chaque vente primaire, apres toute reduction ou promotion applicable.
6.2 L'Artiste choisit un taux de redevance sur les ventes secondaires compris entre 5 % et 15 %.
6.3 Les frais Stripe, remboursements et chargebacks sont a la charge de Make It Art et ne reduisent pas la base de calcul de la commission.
6.4 Make It Art emet a destination de l'Artiste la facture de commission correspondante. L'automatisation des versements et de la commission via Stripe Connect fera l'objet d'une phase ulterieure et d'une validation distincte.
6.5 Les modalites de remuneration de l'Artiste avant l'activation de Stripe Connect sont celles communiquees et acceptees separement par les parties.
6.6 Les frais de gaz et les modalites blockchain sont repartis conformement aux regles de la Plateforme.
